...
DUCKAI_BROWSER_CLEANUP_ON_START=1 # 默认 1。启动时清理上次残留的 Duck.ai 页面
...
BROWSER_PAGE_IDLE_SECONDS=600         # 浏览器页空闲多少秒后关闭，0 表示不关闭
BROWSER_PAGE_MAX_AGE_SECONDS=7200     # 浏览器页最长复用秒数，0 表示不轮换
```
